...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <a href="http://localhost:8080/Tugas2ConsumeAPI_billy/ConsumeCountriesAPI.php" class="text-start">
                    <button class="btn btn-warning btn-lg" type="button">Countries</button>
                </a>
            </div>
            <div class="col-md-6">
                <a href="http://localhost:8080/Tugas2ConsumeAPI_billy/ConsumeTeamAPI.php" class="text-start">
